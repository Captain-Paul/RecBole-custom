...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', '-d', type=str, default='mlRating', help='name of datasets')
    parser.add_argument('--config_files', type=str, default='configs/mlRating.yaml', help='config files')
